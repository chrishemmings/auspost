...
class ShipmentApi
{
     ...
     * Create Labels
     *
     * @param  \ChrisHemmings\AusPost\Client\Model\CreateLabelsRequest $labels Labels to create (optional)
     *
     ...
     */
    public function labelsPost($labels = null)
    {
        list($response) = $this->labelsPostWithHttpInfo($labels);
        return $response;
    }
     ...
     */
    public function labelsPostWithHttpInfo($labels = null)
    {
        $returnType = '\ChrisHemmings\AusPost\Client\Model\CreateLabelsResponse';
        $request = $this->labelsPostRequest($labels);
     ...
     */
    public function labelsPostAsync($labels = null)
    {
        return $this->labelsPostAsyncWithHttpInfo($labels)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function labelsPostAsyncWithHttpInfo($labels = null)
    {
        $returnType = '\ChrisHemmings\AusPost\Client\Model\CreateLabelsResponse';
        $request = $this->labelsPostRequest($labels);
     ...
     */
    protected function labelsPostRequest($labels = null)
    {
     ...
     *
     * @param  \ChrisHemmings\AusPost\Client\Model\CreateShipmentsRequest $shipments Shipments to create (optional)
     *
     * @throws \ChrisHemmings\AusPost\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ChrisHemmings\AusPost\Client\Model\CreateShipmentsResponse
     */
    public function shipmentsPost($shipments = null)
    {
        list($response) = $this->shipmentsPostWithHttpInfo($shipments);
        return $response;
    }
     ...
     */
    public function shipmentsPostWithHttpInfo($shipments = null)
    {
        $returnType = '\ChrisHemmings\AusPost\Client\Model\CreateShipmentsResponse';
        $request = $this->shipmentsPostRequest($shipments);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shipmentsPostAsync($shipments = null)
    {
        return $this->shipmentsPostAsyncWithHttpInfo($shipments)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shipmentsPostAsyncWithHttpInfo($shipments = null)
    {
        $returnType = '\ChrisHemmings\AusPost\Client\Model\CreateShipmentsResponse';
        $request = $this->shipmentsPostRequest($shipments);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function shipmentsPostRequest($shipments = null)
    {
