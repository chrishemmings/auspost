...
class ShipmentToAddress implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['apcn']) && (mb_strlen($this->container['apcn']) > 10)) {
            $invalidProperties[] = "invalid value for 'apcn', the character length must be smaller than or equal to 10.";
        }
        ...
        if (!is_null($this->container['delivery_instructions']) && (mb_strlen($this->container['delivery_instructions']) > 128)) {
            $invalidProperties[] = "invalid value for 'delivery_instructions', the character length must be smaller than or equal to 128.";
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ShipmentToAddress., must be smaller than or equal to 40.');
        }
    ...
    public function setBusinessName($business_name)
    {
        if (!is_null($business_name) && (mb_strlen($business_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $business_name when calling ShipmentToAddress., must be smaller than or equal to 40.');
        }
    ...
    {
        if (!is_null($apcn) && (mb_strlen($apcn) > 10)) {
            throw new \InvalidArgumentException('invalid length for $apcn when calling ShipmentToAddress., must be smaller than or equal to 10.');
        }
    ...
    public function setSuburb($suburb)
    {
        if ((mb_strlen($suburb) > 30)) {
            throw new \InvalidArgumentException('invalid length for $suburb when calling ShipmentToAddress., must be smaller than or equal to 30.');
        }
    ...
    public function setState($state)
    {
        if ((mb_strlen($state) > 3)) {
            throw new \InvalidArgumentException('invalid length for $state when calling ShipmentToAddress., must be smaller than or equal to 3.');
        }
    ...
    public function setPostcode($postcode)
    {
        if ((mb_strlen($postcode) > 4)) {
            throw new \InvalidArgumentException('invalid length for $postcode when calling ShipmentToAddress., must be smaller than or equal to 4.');
        }
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling ShipmentToAddress., must be smaller than or equal to 2.');
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 50)) {
            throw new \InvalidArgumentException('invalid length for $email when calling ShipmentToAddress., must be smaller than or equal to 50.');
        }
    ...
    {
        if (!is_null($delivery_instructions) && (mb_strlen($delivery_instructions) > 128)) {
            throw new \InvalidArgumentException('invalid length for $delivery_instructions when calling ShipmentToAddress., must be smaller than or equal to 128.');
        }
